...
\caption{May - Must - Irrelevant Set of Support}\label{fig:maymust}\anitha{I should change it from not to irrelevant}
\end{figure}
...
\anitha{Should we we have a series of pictures here illustrating different options we want discuss?}
